  ...
  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
      <div class="container-fluid">
        <div class="navbar-wrapper d-inline p-1">
    	  <!-- on/off -->
	         <form method="post" name="onoff" action="pausse.php">
		   		 <?php
		   		 if($_SESSION['statu']=="connecte"){
 ...
 <!-- End Navbar --> 
		<div class="content">
	    	<div class="row p-4">
		    	<?php 
					if($_SESSION['statu']=="connecte"){
			    		echo"	<h1 class='text-primary text-uppercase p-1' style='margin-left: 10%'>Bienvenue !</h1>";
					}else{
			  		  	echo"	<h1 class='text-primary text-uppercase p-1' style='margin-left:10%'>Vous êtes en pause !</h1>";
					}
				?>
	    	</div>
			<div class="row">
			<!--  ****** Profile  ********   --> 
				<?php 
					if($_SESSION['statu']=="connecte"){
						echo"<div class='card card-stats col-md-4 shadow' style='margin-left: 10%; height: 200px;'>
